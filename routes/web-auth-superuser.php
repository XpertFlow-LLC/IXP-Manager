...
Route::group( [ 'prefix' => 'faucet-controller' ], function() {
    Route::get(     'list',                             'SDNController@list'     )->name( 'faucet-controller/list'  );
    Route::get(     'status',                           'SDNController@status'   )->name( 'faucet-controller/status' );
    Route::get(     'add',                              'SDNController@edit'     )->name( 'faucet-controller/add'   );
    Route::get(     'edit/{id}',                        'SDNController@edit'     )->name( 'faucet-controller/edit'  );
    Route::get(     'view/{id}',                        'SDNController@view'     );
    Route::get(     'delete/{id}',                      'SDNController@delete'   );
    Route::get(     'gen-config/{id}',                  'SDNController@genConfig');
    Route::post(    'store',                            'SDNController@store'    );
