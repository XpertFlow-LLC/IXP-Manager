...
<?php $this->section( 'content' ) ?>
    ...
    <div  class="well col-sm-12">
        ...
        <?= Former::text( 'handle' )
            ->label( 'Handle*' )
            ->placeholder( 'fc1-lan1' )
            ->blockHelp( "The handle is like the faucet controller's name. It is suggested you use something like: <code>purpose-proto-lan</code>. A
                good example of this is <code>fc1-lan1</code> for <em>controller server #1</em> on <em>lan1.</em>
        ...
        <?= Former::text( 'api' )
            ->label( 'API Endpoint' )
            ->placeholder( "https://fc1_ixp.pkix.com/api" )
        ...
        <?= Former::text( 'faucet_exception_log')
            ->label( 'Faucet Exception Log*' )
